...
const CompanyForm = ({ open, setOpen }) => {
  ...
  const [errMsg, setErrorMsg] = useState({status:false,message:""});
  ...
  const onSubmit = async(data) => {
    ...
    if (profileImage) {
        ...
        uri = await handelFileUpload(profileImage);
    }
    ...
    try{
      ...
      if(res.status==='failed'){
        ...
        setErrorMsg({status:"success", message:"Company Profile Updated!"});
              ...
              >
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  >
                    ...
                    <div className='mt-4'>
                      {
                        isLoading ? (<Loading/>):(<CustomButton
                        type='submit'
